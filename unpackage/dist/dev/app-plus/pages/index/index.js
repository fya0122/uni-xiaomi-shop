              ...
              _c(
                ...
                _vm._l(_vm.list, function(item) {
                  return _c(
                    "block",
                    { key: item.id },
                    [_c("common-list", { attrs: { item: item } })],
                    1
                  )
                }),
                1
...
"use strict";
/* WEBPACK VAR INJECTION */(function(plus, __f__) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 13));
...
var dom = weex.requireModule('dom');var currentWebview = plus.webview.currentWebview();var _default = { components: { SumSlider: _sumSlider.default, SumIndexNavs: _sumIndexNavs.default, Divider: _divider.default, SumThreeAdv: _sumThreeAdv.default, SumOneAdv: _sumOneAdv.default, CommonList: _commonList.default }, data: function data() {return { refreshText: '', // 下拉刷新的text
      ...
      tabIndex: 0, tabBars: [{ name: '关注', id: 'guanzhu', template: 'index' }, { name: '推荐', id: 'tuijian', template: 'special' }, { name: '体育', id: 'tiyu', template: 'special' }, { name: '热点', id: 'redian', template: 'special' }, { name: '财经', id: 'caijing', template: 'special' }, { name: '娱乐', id: 'yule', template: 'special' }, { name: '军事', id: 'junshi', template: 'special' }, { name: '历史', id: 'lishi', template: 'special' }, { name: '本地', id: 'bendi', template: 'special' }], swipers: [{ src: '../../static/images/demo/demo4.jpg' }, { src: '../../static/images/demo/demo4.jpg' }, { src: '../../static/images/demo/demo4.jpg' }], indexNavs: [{ src: '../../static/indexnav/1.png', name: '新品分类' }, { src: '../../static/indexnav/2.gif', name: '小米众筹' }, { src: '../../static/indexnav/3.gif', name: '以旧换新' }, { src: '../../static/indexnav/4.gif', name: '1分拼团' }, { src: '../../static/indexnav/5.gif', name: '超值特卖' }, { src: '../../static/indexnav/6.gif', name: '小米秒杀' }, { src: '../../static/indexnav/7.gif', name: '真心想要' }, { src: '../../static/indexnav/8.gif', name: '电视热卖' }, { src: '../../static/indexnav/9.gif', name: '家电热卖' }, { src: '../../static/indexnav/10.gif', name: '米粉卡' }], threeAdv: [{ src: '../../static/images/demo/demo1.jpg' }, { src: '../../static/images/demo/demo2.jpg' }, { src: '../../static/images/demo/demo3.jpg' }],
  ...
  created: function created() {
    ...
    currentWebview.addEventListener('show', function () {
      console.log(__f__('onshow添加成功', " at pages\\index\\index.nvue:121"));
    });
  },
  beforeDestroy: function beforeDestroy() {
    // const currentWebview = plus.webview.currentWebview()
    currentWebview.removeEventListener('show', function () {
      console.log(__f__('onshow移除成功', " at pages\\index\\index.nvue:127"));
    });
  },
  watch: {
